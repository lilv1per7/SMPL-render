# TinyRender + SMPL 实时渲染项目文档 (From 0 to 1)

本文档旨在为你提供一份**无比详细、逻辑严密、面向代码**的项目复现与学习指南。无论你是为了面试准备，还是为了彻底掌握图形学与参数化人体建模，这份文档都将是你最坚实的后盾。
